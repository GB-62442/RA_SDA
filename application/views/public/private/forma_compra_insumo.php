				...
				<div class="row">
					<div class="col-12">
					    ...
					    <div class="form-group">
					      ...
					      <input type="number" min="1" step="1" class="form-control" id="cantidad" aria-describedby="emailHelp" placeholder="Cantidad del insumo">
							<!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->					    
						</div>
					    ...
					    <div class="form-group">
					      ...
					      <input type="number" min="1" step="1" class="form-control" id="precio" aria-describedby="emailHelp" placeholder="precio del insumo">
							<!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->					    
						</div>
