	...
	<div class="pt-2">
		...
		<div class="row m-2">
			<div class="row">
				...
				<div class="col">
					<!-- <button class="form-control btn btn-primary btn-sm" type="button">CREAR USUARIO <i class="fa-solid fa-plus"></i></button> -->
				</div>
				<div class="col">
<!-- 					<button class="form-control btn btn-primary btn-sm" type="button">HISTORIAL <i class="fa-solid fa-chart-simple"></i></button>
 -->				</div>
				<div class="col">
					<a href="<?=base_url('/controlador/detalleusuario')?>" class="form-control btn btn-primary btn-sm" type="button">AGREGAR <i class="fa-solid fa-chart-simple"></i></a>
...
<!-- 	<div class="d-flex justify-content-around m-2">
		...
		<a href="http://localhost/inventario/controlador/usuarios">usuarios</a>
